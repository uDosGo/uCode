...
def main():
    ...
    # Handle 'run' subcommand: ucode1 run <file>
    if len(sys.argv) > 2 and sys.argv[1] == 'run':
        _run_bas_file(sys.argv[2])
        return
    ...
    if args.file and not args.file.endswith('.bas'):
        print(f"Error: expected a .bas file, got '{args.file}'")
        sys.exit(1)
