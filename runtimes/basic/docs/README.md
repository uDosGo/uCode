...
|-------|-----------|---------|-----|
| **uCode1** | Text/ASCII/Teletext + Sprite/BOB | BBC BASIC runtime, grid/cell system, teletext, AMOS-style sprites & BOBs | `ucode` |
| **uCode2** | ProseUI | Markdown editor, document viewer, learning environment | `ucode2` |
...
- [uCode2 — ProseUI markdown editor](https://github.com/uDosGo/uCode2)
- [uCode3 — Vector/SVG layer (HomeNest)](https://github.com/uDosGo/uCode3)
- [uCode4 — Spatial/3D layer](https://github.com/uDosGo/uCode4)
- [AMOS Shim](core_py/bbc/amos_shim.bbc) — AMOS-style sprite, BOB, collision, and sound commands for BBC BASIC
