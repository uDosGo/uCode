---
title: "Getting started (uHomeNest v3.9)"
status: draft
last_updated: 2026-04-22T23:26:13+10:00
category: tutorial
tags: [tutorial, ucode3]
description: "1. Review `docs/boundary.md` and `docs/base-runtime-boundary.md` so local runtime ownership stays inside **uHomeNest**."
---
